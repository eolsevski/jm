...
public class DatabaseSeeder {
    ...
    private void seedProductsImagesTable() {
        if (productRepository.count() == 0) {
            ...
            product1.setImages(new ArrayList<>(Arrays.asList(image1, image2)));

            product2.setName("product 2");
            product2.setDescription("product 2 description");
            product2.setPrice(3.75F);
            product2.setImages(new ArrayList<>(Arrays.asList(image3, image4)));

            product3.setName("product 3");
            product3.setDescription("product 3 description");
            product3.setPrice(4.75F);
            product3.setImages(new ArrayList<>(Arrays.asList(image5, image6)));
